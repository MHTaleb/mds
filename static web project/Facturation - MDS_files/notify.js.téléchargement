function notify(e) {
    ...
    e.cNotify = function(t) {
        var n = {
				parent: "", /* parent id */
                type: "default", /* alert | success | error | warning | info */
                title: null,
                message: null,
                position: {
                    x: "center", /* right | left | center | "" to relative position */
            ...
            s = {
                ...
                _setContent: function() {
                    ...
                    if (t.icon) {
                        r.prepend('<div class="notify-icon '+t.type+'"></div>')
                    } else {
                ...
                _poisition: function() {
                    ...
                    if (i > 1) {
                        ...
                        }    this is used to hide the overflow notifications*/
                    }
                },
                _reposition: function(n) {
                    ...
                    } else if (n.match(/notify\-top\-(right|left|center|full|top)/g)) {
                        n = n.match(/notify\-top\-(right|left|center|full|top)/g)[0]
                    } else {
                        return false
                    }
                    var i = 0;
